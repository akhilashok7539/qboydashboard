...
@Component({
  selector: 'app-edit-menu-approval-request',
  templateUrl: './edit-menu-approval-request.component.html',
  styleUrls: ['./edit-menu-approval-request.component.css']
})
export class EditMenuApprovalRequestComponent implements OnInit {
  ...
  ngOnInit() { this.restaurantmenuFormRegistration = this.formbuilder.group(
    {
